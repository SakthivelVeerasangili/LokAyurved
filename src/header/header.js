      ...
      <div className="global__container">
        ...
        <div className="what__lokayurved">
          <div className="what__loka__contant">
            ...
            <p id="about__loka">
              LokAyurved is all about educating and experiencing individuals
        ...
        <div className="lokayarved__program">
          <h1 id="program__heading">
            What you will take home from us after Lokayurved Program?
          </h1>
          ...
          <div className="place__contant">
            ...
            <div className="place__topic">
              ...
              <p className="invite__para">
                ...
                LokAyurved Seminars and Customized Ayurveda Living Programs.
              </p>
              <a
                id="invite__btn"
        ...
        <div className="footer">
          ...
          <div className="copyright">
            <div className="copy__left">
              <h6>
                © 2019 LokAyurved. All rights reserved. Designed and Developed
